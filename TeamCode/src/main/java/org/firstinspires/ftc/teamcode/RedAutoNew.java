    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (valLeft == 0) {
                ...
                encoder(1490, 1160, 1160, 1460, .2, 7);
                armServo.setPosition(.8);
                sleep (400);
                encoder(-325, -325, -325, -325, .5, 5);
                ...
                encoder(50,-50,-50,50, .2, 5);
                encoder(-630, 630, -630, 630, .5 , 2);
                turnAngle(-2, 1, -.2, -.2, .2, .2);
                encoder(400, 400, 400, 400, .1, 5);
                armServo.setPosition(.8);
                sleep(400);
                encoder(-500, -500, -500, -500, .3, 5);
                encoder(630, -630, 630, -630, .5 , 2);
                turnAngle(270.5, 271.5, .2, .2, -.2, -.2);
                ...
                encoder(100,-100,-100,100, .2, 5);
                encoder(-630, 630, -630, 630, .5 , 3);
                turnAngle(-2, 1, -.2, -.2, .2, .2);

                encoder(310, 310, 310, 310, .2, 3);
                armServo.setPosition(.8);
                sleep(1000);
                encoder(-240, -240, -240, -240, .3, 5);
                encoder(630, -630, 630, -630, .5 , 2);
                turnAngle(270.5, 271.5, .2, .2, -.2, -.2);
